...
public interface Params {
    /**
     * see <a
     * href="http://developers.soundcloud.com/docs/api/tracks">developers.
     * soundcloud.com/docs/api/tracks</a>
     */
    interface Track {
    ...
    /**
     * see <a href="http://developers.soundcloud.com/docs/api/users">developers.
     * soundcloud.com/docs/api/users</a>
     */
    interface User {
    ...
    /**
     * see <a
     * href="http://developers.soundcloud.com/docs/api/comments">developers
     * .soundcloud.com/docs/api/comments</a>
     */
    interface Comment {
